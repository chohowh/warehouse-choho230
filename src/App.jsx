...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Sarabun', sans-serif; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
  ...
  .infobox .line1 { font-weight: 900; font-size: 26px; color: #1e293b; display: flex; align-items: center; justify-content: center; gap: 10px; }
  .infobox .line2 { font-size: 19px; color: #4b6079; margin-top: 3px; font-weight: 600; }
...
const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    notes: [
      "การยืนยันไฟล์ใหม่จะ \"แทนที่คิวเดิมทั้งหมด\" ไม่ใช่การเพิ่มต่อ — ถ้ามีรถเช็คอินไปแล้ว ระบบจะจับคู่ทะเบียนกับคิวใหม่ให้อัตโนมัติ",
