    ...
    <div ref={containerRef} style={{ display: "flex", flexDirection: "column", height: "100%", background: "#fff" }}>
      <div style={{ padding: fs ? "20px 36px" : "10px 20px", borderBottom: "1px solid #f3f4f6", display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
        ...
        {!isMobile && <button
          ...
          style={{ border: "1px solid #e5e7eb", borderRadius: 8, background: fs ? "#111" : "#f9fafb", cursor: "pointer", padding: fs ? "10px 18px" : "4px 8px", fontSize: fs ? 30 : 13, fontWeight: 800, lineHeight: 1, color: fs ? "#fff" : "#374151", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", marginLeft: fs ? "auto" : undefined }}
        >
          {fs ? "✕" : "TV"}
        </button>}
      </div>
